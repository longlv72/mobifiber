...
<body>
    ...
    <div class="app-menu navbar-menu d-none">
        ...
        <div class="navbar-brand-box">
            ...
            <a href="index.html" class="logo logo-dark">
                <span class="logo-sm">
                    <img src="{{URL::asset($custom_asset.'/assets/images/logo-sm.png')}}" alt="" height="22">
                </span>
                <span class="logo-lg">
                    <img src="{{URL::asset($custom_asset.'/assets/images/logo-dark.png')}}" alt="" height="17">
                </span>
            </a>
            <!-- Light Logo-->
            <a href="index.html" class="logo logo-light">
                ...
                <span class="logo-lg">
                    <img src="{{URL::asset($custom_asset.'/assets/images/logo-light.png')}}" alt="" height="17">
                </span>
            </a>
    ...
    <div class="modal fade" id="update_info_user_modal" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalgridLabel">Thông tin của tôi</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('save-profile-engineer-employee')}}" id="form_update_profile" method="POST">
                        @csrf
                        <div class="row g-3">
                            <div class="col-xxl-6">
                                <div>
                                    <label for="u_username" class="form-label">Tên đăng nhập</label>
                            ...
                            <div class="col-xxl-6">
                                <div>
                                    ...
                                    <input type="email" class="form-control" name="u_email" value="{{ Auth::user()->email }}" id="u_email" placeholder="Nhập email">
                                </div>
                            </div><!--end col-->
                        </div>
                        <div class="row g-3 mt-2">
                            <div class="col-xxl-6">
                                <div>
                                    <label for="u_first_name" class="form-label">Tên<span class="required">*</span></label>
                                    <input type="text" class="form-control" id="u_first_name" name="u_first_name" value="{{Auth::user()->firstname}}" placeholder="Nhập tên">
                                </div>
                            </div><!--end col-->
                            <div class="col-xxl-6">
                                <div>
                                    <label for="u_last_name" class="form-label">Họ tên đệm<span class="required">*</span></label>
                                    <input type="text" class="form-control" id="u_last_name" name="u_last_name" value="{{ Auth::user()->lastname }}" placeholder="Nhập họ tên đệm">
                                </div>
                            </div><!--end col-->
                        </div>
                        <div class="row g-3 mt-2">
                            <div class="col-xxl-6">
                                <div>
                                    <label for="u_address" class="form-label">Địa chỉ</label>
                                    <input type="text" class="form-control" name="u_address" value="{{ Auth::user()->address }}" id="u_address" placeholder="Nhập địa chỉ">
                                </div>
                            </div><!--end col-->
                            <div class="col-xxl-6">
                                <div>
                                    <label for="u_phone" class="form-label">Số điện thoại<span class="required">*</span></label>
                                    <input type="text" class="form-control" id="u_phone" name="u_phone" value="{{ Auth::user()->phone }}"  placeholder="Nhập số điện thoại">
                                </div>
                            </div><!--end col-->
                        </div>
                        <div class="row g-3 mt-2">
                            <div class="col-lg-12">
                                <div class="hstack gap-2 justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-primary" id="btn_save_info">Lưu</button>
                                </div>
                            </div><!--end col-->
                        </div><!--end row-->
                    </form>
    ...
    <div class="modal fade" id="change_password_info_user_modal" tabindex="-1" aria-labelledby="exampleModalgridLabel" aria-modal="true">
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalgridLabel">Thay đổi mật khẩu</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form action="{{ route('change-pass-engineer-employee')}}" id="form_change_password" method="POST">
                        @csrf
                        <input type="hidden" name="change_pass_user_id" id="change_pass_user_id" value="{{ Auth::user()->id }}"/>
                        <div class="row g-3  d-flex justify-content-center">
                            <div class="col-xxl-6">
                                <label for="old_password" class="form-label">Mật khẩu cũ<span class="required">*</span></label>
                                <div class="position-relative auth-pass-inputgroup">
                                    <input type="password" class="form-control pe-5 password-input" name="old_password" id="old_password" placeholder="Mật khẩu cũ" />
                        ...
                        <div class="row g-3 mt-2  d-flex justify-content-center">
                            <div class="col-xxl-6">
                                ...
                                <div class="position-relative auth-pass-inputgroup">
                                    <input type="password" class="form-control pe-5 password-input" name="new_password" id="new_password" placeholder="Mật khẩu mới" />
                                    <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted shadow-none password-addon" type="button"><i class="ri-eye-fill align-middle"></i></button>
                                </div>
                            </div><!--end col-->
                        </div>
                        <div class="row g-3 mt-2  d-flex justify-content-center">
                            <div class="col-xxl-6">
                                <label for="conf_password" class="form-label">Xác nhận mật khẩu<span class="required">*</span></label>
                                <div class="position-relative auth-pass-inputgroup">
                                    <input type="password" class="form-control pe-5 password-input" placeholder="Xác nhận mật khẩu" name="conf_password"  id="conf_password" />
                                    <button class="btn btn-link position-absolute end-0 top-0 text-decoration-none text-muted shadow-none password-addon" type="button"><i class="ri-eye-fill align-middle"></i></button>
                                </div>
                            </div><!--end col-->
                        </div>
                        ...
                        <div class="row g-3 mt-2">
                            <div class="col-lg-12">
                                <div class="hstack gap-2 justify-content-end">
                                    <button type="button" class="btn btn-light" data-bs-dismiss="modal">Đóng</button>
                                    <button type="submit" class="btn btn-primary" id="btn_change_password">Lưu</button>
                                </div>
                            </div><!--end col-->
                        </div><!--end row-->
                    </form>
